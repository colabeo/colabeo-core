define(function(require, exports, module) {
     ...
     *   * Additionally, only some of the operations preserve immutability.
    ...
    function Vector(x,y,z){
        if (arguments.length == 1){
            if (x instanceof Array)  this.setXYZ.apply(this, x);
   ...
   /**
    ...
    /**
     * Rotate around x, y, and z axes by of theta, phi, psi respectively.
     * Angles are specified in a Vector v.  
     *
     * * TODOs: 
     *   * Is this format (rotate by angle Vector) considered standard?
     * @name Vector#rotate
     * @function
     * @returns {Vector}
     */
   ...
   /**
     ...
     *       
     * * TODOs:
     *   * Confirm this is a method worth putting in the public space.
   ...
   /**
    ...
    /**
     * Reflect this Vector AGAINST provided vector.
     *
     * * TODOs: 
     *   * This isn't the usual notion of reflect,
     *     which I think is "reflect across", as in "flip"
     *     This is more "reflect against".
     * @name Vector#reflect
     * @function
     */
