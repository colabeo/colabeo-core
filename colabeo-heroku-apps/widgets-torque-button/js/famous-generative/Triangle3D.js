define(function(require, exports, module) {
    ...
    function Triangle3D(opts)
    {
        ...
        this.p4Surf = new FamousSurface({size:[size,size]}); 
        ...
        this.p5Surf = new FamousSurface({size:[size,size]}); 
        ...
        this.p6Surf = new FamousSurface({size:[size,size]}); 
    ...
    {                
        ...
        this.p1Surf.mtx = FM.move(FM.identity, p1.toArray());
        this.p2Surf.mtx = FM.move(FM.identity, p2.toArray()); 
        this.p3Surf.mtx = FM.move(FM.identity, p3.toArray()); 
        ...
        var xDot = this.xAxis.dot(cross); 
        var yDot = this.yAxis.dot(cross); 
        var zDot = this.zAxis.dot(cross); 

        console.log(xDot, yDot, zDot); 

        if(zDot < 0)
        {
            p1 = new Vector(p2x,p2y,p2z); 
            p2 = new Vector(p1x,p1y,p1z); 
        ...
        xDot = this.xAxis.dot(cross); 
        yDot = this.yAxis.dot(cross); 
        zDot = this.zAxis.dot(cross); 
        ...
        // console.log('theta: ', theta, Utils.rad2deg(theta)); 
        // theta = Utils.deg2rad(123); 

        this.mtx = FM.scale(this.invSize*b, this.invSize*h, 1.0);     
        this.mtx = FM.multiply(this.mtx, FM.rotateZ(0), FM.rotate(thetaX, thetaY, 0));                        
