...
//            else if (target.hasClass("fa-pencil")) this.eventOutput.emit('editFavor', this.model);
    ...
    EditItemView.prototype = Object.create(View.prototype);
    EditItemView.prototype.constructor = EditItemView;

    // render is a reserved function. Should not use while using famous
    EditItemView.prototype.renderView = function(showButtons){
