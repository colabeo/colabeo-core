define(function(require, exports, module) {
     ...
     *
     * @name FamousMatrix#average
     * @function
     *
     * @param {FamousMatrix} M1 f(M1,M2,0) = M1
     * @param {FamousMatrix} M2 f(M1,M2,1) = M2
     * @param {number} t
     * @returns {FamousMatrix}
     */
    FamousMatrix.average = function(M1,M2,t){
        t = (t === undefined) ? 0.5 : t;
        var specM1 = FamousMatrix.interpret(M1);
        var specM2 = FamousMatrix.interpret(M2);
        ...
        return FamousMatrix.build(specAvg);
    }
