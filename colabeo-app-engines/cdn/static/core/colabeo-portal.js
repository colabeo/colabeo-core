...
/*
//`window.colabeoLoading` is a flag that keeps loading bookmarklet safe
*/


var colabeo = {};
var COLABEO_DEBUG = false;
var COLABEO = {};
var _colabeoBody = document.getElementById('colabeoBody');
if (!_colabeoBody) {
	_colabeoBody = document.createElement('div');
	_colabeoBody.setAttribute('id', 'colabeoBody');
	document.body.appendChild(_colabeoBody);
}

colabeo._sendToSimulator = function(type, data) {
	if (!_colabeoBody)
		return;
	...
	_colabeoBody.dispatchEvent(evt);
};


(function() {
  var Bobo, DemoboPortal, Dispatcher, base, breaker, cacheJS, connectScript, colabeoHandlers, extend, faviconScript, togetherScript, loadJS, nativeForEach, remotes, version, _,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  if (!window.colabeoLoading) {
    /* 
    //Set the flag so that another colabeo script wont interrupt
    */

    window.colabeoLoading = 1;
    if (window.colabeoOn) {
      /* 
      //If colabeo is already on, do nothing
      */

      delete window.colabeoLoading;
    } else {
      window.colabeoOn = 1;
      /*
      // Baseline Setup
      ...
      */
      ...
      version = '0.9.2';
      base = window.colabeoBase + '/apps/';
      connectScript = window.colabeoBase + '/core/connect.js';
      faviconScript = window.colabeoBase + '/core/favicon.js';
      togetherScript = window.colabeoBase + '/core/together.js?1202';
      /*
      ...
      */
      ...
      cacheJS = function(src) {
        ...
        cache.data = src;
        cache.className = 'colabeoCache';
        cache.width = 0;
        cache.height = 0;
        return document.body.appendChild(cache);
      };
      /*
      // Try to preload colabeo API and other scripts as early as possible
      */
    ...
    _.extend = function(obj) {
      ...
      Bobo = (function() {
        ...
        */
        function Bobo(portal) {
          ...
          this._events = {};
          defaultConfig = {
            'developer': 'developer@colabeo.com'
          };
        ...
        */
        ...
        /*
        // set event listeners. which will be in turn set to colabeo when the bobo is instantiated
        */
      ...
      */
      ...
      colabeoHandlers = {
        ...
        */
        ...
        /*
        // Handler that runs when colabeo is enabled
        */
        ...
        /*
        // Handler that runs when colabeo is disabled
        */
      ...
      DemoboPortal = (function() {
        ...
        */
        function DemoboPortal() {
          this.attributes = {};
          this.COLABEO = window.COLABEO;
          this.colabeo = window.colabeo;
          this.COLABEO_DEBUG = window.COLABEO_DEBUG;
          this._events = {};
          this.initialize();
        }
        ...
        */
        ...
        DemoboPortal.prototype.getBoboRoutes = function() {
          ...
          if (window.colabeoDevBobos) {
            _ref = window.colabeoDevBobos;
            for (exp in _ref) {
              arr = _ref[exp];
              temp = [];
              ...
              window.colabeoDevBobos[exp] = temp;
            }
            return window.colabeoDevBobos;
          }
          // Generic adaptors
          toReturn = {
            'generic': base + 'generic.js?' + Math.random()
          };
          if (window.colabeoAddBobos) {
            count = 0;
            _ref1 = window.colabeoAddBobos;
            for (exp in _ref1) {
              arr = _ref1[exp];
        ...
        */
        ...
        DemoboPortal.prototype.initialize = function() {
          ...
          */
          this.on('change:bobos', colabeoHandlers.handlerBobosChange);
          this.on('change:curBobo', colabeoHandlers.handlerCurBoboChange);
          this.on('add:bobos', colabeoHandlers.handleBoboAdd);
          this.turnOnFavicon();
          window.COLABEO.init = function() {};
        ...
        */
        ...
        DemoboPortal.prototype.saveLastBoboID = function() {
          return window.localStorage.setItem('colabeoLastBobo', this.get('curBobo').getInfo('boboID'));
        };
        ...
        */
        ...
        DemoboPortal.prototype.loadLastBoboID = function() {
          return window.localStorage.getItem('colabeoLastBobo');
        };
      ...
      */
			...
			var colabeoPortal;
			colabeoPortal = new DemoboPortal();
			window.colabeoPortal = colabeoPortal;
			if (top === self) {
			...
			return loadJS(faviconScript, function() {
				...
				return colabeoPortal.set('favicon', favicon);
			});
